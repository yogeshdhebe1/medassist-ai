...
from app.modules.ai_apis.inference_kidney import predict_kidney_disease
...
class AIPredictionService:
    ...
    def predict_kidney_disease_risk(self, user_id: uuid.UUID, payload: KidneyDiseasePredictionRequest):
        patient = self._get_or_create_patient(user_id)
        result = predict_kidney_disease(**payload.model_dump())
        return self._persist_and_format(patient.id, "kidney_disease", payload.model_dump(), result)
